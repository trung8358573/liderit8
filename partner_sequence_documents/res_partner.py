...
class CustomResPartner(osv.osv):
    ...
    _columns = {
        ...
        'purchase_quo_id': fields.many2one('ir.sequence','Secuencia Propuestas de Compra', help="Secuencia personalizada para propuestas de compra"),
        ...
        'sale_quo_id': fields.many2one('ir.sequence','Secuencia Ofertas de Venta', help="Secuencia personalizada para ofertas de venta"),
        ...
        'picking_seq_id': fields.many2one('ir.sequence','Secuencia Albaránes', help="Secuencia personalizada para albaranes"),
